    ...
    <div className='bg-gray-50'>
      ...
      <div className='container mx-auto py-8'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            {product.image && (
           <div className='rounded-2xl bg-white p-4 aspect-square overflow-hidden shadow-lg'>
            ...
            <div className='flex flex-col gap-4'>
                <h1 className='text-2xl text-gray-800 md:text-3xl font-bold p-2'>
                    {product.title}
                </h1>
                ...
                <div className='flex flex-col gap-2 mt-4'>
                    <div className='flex items-center gap-3'>
                        <div className='flex items-baseline gap-1'>
                            ...
                            <span className='text-5xl font-black text-red-600 tracking-tight'>{formatPrice(product.price).replace('$',"")}</span>
                        </div>
                ...
                <div className='flex items-center gap-2 bg-red-50 p-2 rounded-lg animate-pulse'>
                    <span className='text-red-600 font-bold'>💰
                    </span>
                    <span className='text-red-600 font-medium text-sm'>
                        Your save {formatPrice(originalPrice - product.price)}
                    </span>
                </div>
                ...
                <div className='bg-gradient-to-r to-yellow-600/20 from-yellow-500/20 p-4 rounded-xl mt-4'>
                <div className='flex items-center gap-2 text-yellow-800'>
                    <span className='text-xl'>⚡️</span>
                    <span className='font-bold'>Limited Time Offer!</span>
                </div>
                <div className='text-sm text-yellow-700 mt-1 font-bold'>
                Order now before price changes!
                </div>
            </div>
            </div>
            <AddToCartButton product={product} />
            <div className='flex flex-col gap-3 text-sm mt-6 bg-white p-4 rounded-xl shadow-sm border-gray-100 border '>
