  ...
  return (
    <div className='bg-white rounded-lg overflow-hidden relative'>
        <div className='absolute top-2 right-2 z-10'>
            <span className='bg-red-500 text-white text-xs font-bold py-1 px-2 rounded-full animate-bounce '>HOT!</span>
        </div>
        ...
        <div className='p-4'>
            ...
            <div className='flex flex-col'>
                ...
                className='w-full text-center bg-gradient-to-r from-red-500 to-orange-500 text-white py-2 rounded-full text-sm font-bold hover:brightness-110 transition-all cursor-pointer'>
                    GRAB IT NOW!
                    </Link>
                <div className='text-xs text-red-500 text-center mt-1 animate-pulse'>⚡️ Limited time offer!</div>
            </div>
        </div>
    </div>
  )
