   ...
   <Form action={formAction} className='max-w-md mx-auto my-16 p-8 bg-white rounded-lg shadow-md'>
    ...
    <div className='space-y-6'>
        ...
        <div className='text-center'>
            ...
            <p className='text-xs text-gray-500 mb-4'>🕒 Plus get free shipping on all orders over $15.00!</p>
        </div>
        <button type='submit' disabled={isPending}
        className={`w-full cursor-pointer bg-rose-600 text-white py-3 rounded-md hover:by-rose-700 transition-colors font-medium flex items-center justify-center gap-2 ${isPending ?'cursor-not-allowed':''}`}
        >
            {isPending?(
                <React.Fragment>
